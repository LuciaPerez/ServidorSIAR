        ...
        <div class="container">
            ...
            <jsp:param name="page" value="printers"/>
              ...
              <div class="col-sm-10">
                    ...
                    <h1 class="font my-title">Impresoras</h1>
                    ...
                    <table class="font table table-striped">  
                     <thead>
                        ...
                        <% 
                            ArrayList ln = (ArrayList)request.getSession().getAttribute("LIST_PRINTERS");
                            int i=0;
                            int len=ln.size();
                            while(i<len){
                                Printer p = (Printer)ln.get(i);
                        %>
                      <tbody>
                        <tr class="clickableRow"> 
                        <form method="post" name="<% out.print(p.getId()); %>" action="/ServidorSIAR/Controller">
                        <input type="hidden" name="action" value="printer_details">
                        <input type="hidden" name="idDevice" value="<%out.print(Integer.toString(p.getId()));%>"> 
                            <td class="<%out.print(p.getId());%>"> <% out.println(p.getIp()); %> </td> 
                            <td class="<%out.print(p.getId());%>"> <% out.println(p.getMac()); %> </td>
                        </form>
                        </tr>
                        <%
                                i++;
