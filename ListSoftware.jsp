...
<head>
    ...
    <%@page import="siar.software.Program" %>
</head>
<BODY>
	<div id="wrap"> 	
		<%@ include file="Header.html" %>      <div class="container">
            ...
            <jsp:param name="page" value="pcs"/>
              ...
              <div class="col-sm-10">
                ...
                <jsp:param name="tab" value="listsoftware"/>
                </jsp:include>  
                    <h1 id="tableTitle" class="font my-title">Listado de programas</h1>
                    
                    <table class="font table table-striped table-condensed">
                      <tbody>         
                        <% 
                            ArrayList ln = (ArrayList)request.getSession().getAttribute("LIST_PROGRAMS");
                            int i=0;
                            int len=ln.size();
                            while(i<len){
                                Program p = (Program)ln.get(i);
                        %>
                        <tr> 
                ...
                <input type="hidden" name="idPc" value="<%out.print(request.getParameter("idPc"));%>">
