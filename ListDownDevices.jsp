...
<BODY>
	<div id="wrap"> 	
        ...
        <div class="container">
            ...
            <jsp:param name="page" value="listdowndevices"/>
            </jsp:include>
              <div class="col-sm-10">
                      
                    <h2 class="font">Listado de dispositivos <strong>dados de baja</strong></h2>
